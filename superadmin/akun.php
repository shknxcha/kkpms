...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
    <a href="tambah_akun.php" class="btn btn-primary mb-2" tabindex="-1" role="button" aria-disabled="true">Tambah Akun</a>
                ...
                <tbody>
                    <?php
                        while($result = mysqli_fetch_array($sql)){
                            ...
                            $queryAnggota = mysqli_query($conn, "SELECT * FROM anggota WHERE id_anggota = $idAnggota");
                            $anggota = mysqli_fetch_assoc($queryAnggota);
                    ?>
                    <tr>
                        <td><?php echo ++$no; ?></td>
                        ...
                        <td >
                            <a onclick="javascript:return confirm('Anda yakin ingin menghapus?')" href="hapus_akun.php?id_akun=<?php echo $result['id_user']; ?>" class="btn btn-danger mb-2">Hapus</a>
                            <a href="edit_akun.php?id_akun=<?php echo $result['id_user']; ?>" type="button" class="btn btn-primary">Edit</a>
                        </td>
                    </tr>
