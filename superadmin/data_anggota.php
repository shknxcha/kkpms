...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Data Anggota</h6>
    </div>
    <h6 class="ml-3 mt-3">Jumlah anggota saat ini: <?php echo $jumlah_anggota; ?> Orang.</h6>
    <div class="card-body">
    <a href="tambah_anggota.php" class="btn btn-primary mb-2" tabindex="-1" role="button" aria-disabled="true">Tambah Data</a>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img class="rounded-circle" src="images/<?php echo $result['foto']; ?>" style="width:100px;">
                        </td>
                        <td><?php echo $result['nama_anggota']; ?></td>
                        <td><?php echo $result['jenis_kelamin']; ?></td>
                        <td><?php echo $result['alamat_anggota']; ?></td>
                        <td><?php echo $result['no_hp']; ?></td>
                        <td><?php echo $result['jabatan']; ?></td>
                        <td >
                            <a onclick="javascript:return confirm('Anda yakin ingin menghapus?')" href="hapus_anggota.php?id_anggota=<?php echo $result['id_anggota']; ?>" class="btn btn-danger mb-2">Hapus</a>
                            <a href="edit_anggota.php?id_anggota=<?php echo $result['id_anggota']; ?>" type="button" class="btn btn-primary">Edit</a>
                        </td>
                    </tr>
