<?php 
    ...
    $query = "SELECT * FROM jenis_simpanan";
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
    <a href="tambah_jenis_simpanan.php" class="btn btn-primary mb-2" tabindex="-1" role="button" aria-disabled="true">Tambah Data</a>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td >
                            <a onclick="javascript:return confirm('Anda yakin ingin menghapus?')" href="hapus_jenis_simpanan.php?id_jenis_simpanan=<?php echo $result['id_jenis_simpanan']; ?>" class="btn btn-danger btn-sm mb-2">Hapus</a>
                            <a href="edit_jenis_simpanan.php?id_jenis_simpanan=<?php echo $result['id_jenis_simpanan']; ?>" type="button" class="btn btn-primary btn-sm" href="id_jenis_simpanan=<?php echo $result['id_jenis_simpanan']; ?>">Edit</a>
                        </td>
                    </tr>
