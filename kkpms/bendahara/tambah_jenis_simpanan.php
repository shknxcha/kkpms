                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Penambahan Data Jenis Simpanan</h6>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="tambah_aksi_jenis_simpanan.php">
                                        
                                <div class="mb-3">
                                    <label class="form-label">Jenis Simpanan</label>
                                    <input type="text" name="jenis_simpanan" class="form-control" placeholder="Jenis Simpanan">
                                </div>
