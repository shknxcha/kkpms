...
$anggota = mysqli_query($conn,("select * from anggota where status='aktif' order by nama_anggota"));
$jenis = mysqli_query($conn,("select * from jenis_simpanan order by jenis_simpanan"));
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Penambahan Data Simpanan</h6>
                                </div>
                                <div class="card-body">
                                    <form method="post" action="tambah_aksi_simpanan.php">
                                        <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <!-- yang ini di copy -->
                                    <input type="date" name="tgl_bayar" class="form-control" placeholder="Tanggal Bayar" max="<?php echo date('Y-m-d'); ?>">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Jumlah Simpanan</label>
                                    <input type="text" name="jml_simpanan" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="id_jenis_simpanan">
                                        ...
                                        <?php if(mysqli_num_rows($jenis)) { ?>
                                            <?php while ($row = mysqli_fetch_array($jenis)) { ?>
