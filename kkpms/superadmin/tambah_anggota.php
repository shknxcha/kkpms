...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Penambahan Data Anggota</h6>
    </div>
    <div class="card-body">
    <form method="post" action="tambah_aksi_anggota.php"  enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="alamat_anggota" class="form-control" placeholder="Alamat Anggota">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="hidden" name="status" class="form-control" value="aktif">
    </div>
