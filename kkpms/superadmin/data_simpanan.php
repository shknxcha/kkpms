                    ...
                    <div class="row">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <a href="tambah_simpanan.php" class="btn btn-primary mb-2" tabindex="-1"
                                        role="button" aria-disabled="true">Tambah Data</a>
                                    <a href="cetak_simpanan.php" class="btn btn-primary mb-2" tabindex="-1"
                                        role="button" aria-disabled="true">Cetak</a>
                                    ...
                                    <tbody>
                                        ...
                                        while ($result = mysqli_fetch_assoc($sql)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $result['tgl_bayar']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $result['jml_simpanan']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $result['jenis_simpanan']; ?>
                                                </td>
                                                <td>
                                                    <a onclick="javascript:return confirm('Anda yakin ingin menghapus?')"
                                                        href="hapus_simpanan.php?id_simpanan=<?php echo $result['id_simpanan']; ?>"
                                                        class="btn btn-danger mb-2">Hapus</a>
                                                    <a href="edit_simpanan.php?id_simpanan=<?php echo $result['id_simpanan']; ?>"
